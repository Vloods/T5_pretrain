...
max_seq_len=256
ent_emb=data/wiki/ent_emb_with_30klost_23oct.npy
kg=wiki
kg_vocab_path=data/wiki/wikidata_unmapped_on_cpnet_lowercase_concept.txt
inhouse=false
...
run_name=dragon____${dataset}__${dt}
log=logs/pretrain__${run_name}.log.txt

###### Training ######
torchrun --nnodes=1 --nproc_per_node=8 dragon_llama.py \
    --dataset $dataset \
