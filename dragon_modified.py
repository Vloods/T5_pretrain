...
def train(args, resume, has_test_split, devices, kg):
    ...
    args.train_statements = f'{args.data_dir}/{args.dataset}/statement/train_0.statement.jsonl'
    args.test_statements = f'{args.data_dir}/{args.dataset}/statement/test_0.statement.jsonl'
    args.dev_statements = f'{args.data_dir}/{args.dataset}/statement/dev_0.statement.jsonl'
    args.inhouse_train_qids = f'{args.data_dir}/{args.dataset}/inhouse_split_qids_0.txt'
    args.train_adj = f'{args.data_dir}/{args.dataset}/graph/train_0.graph.adj.pk'
    args.dev_adj = f'{args.data_dir}/{args.dataset}/graph/dev_0.graph.adj.pk'
    args.test_adj = f'{args.data_dir}/{args.dataset}/graph/test_0.graph.adj.pk'
    ...
    for epoch_id in trange(0, args.n_epochs, desc="Epoch", disable=args.local_rank not in [-1, 0]): #trange(last_epoch + 1, args.n_epochs, desc="Epoch"):
        ...
        for split_number in range(185):
            
            model_path = os.path.join(args.save_dir, 'model.pt')
            args.train_statements = f'{args.data_dir}/{args.dataset}/statement/train_{split_number}.statement.jsonl'
            args.test_statements = f'{args.data_dir}/{args.dataset}/statement/test_{split_number}.statement.jsonl'
            args.dev_statements = f'{args.data_dir}/{args.dataset}/statement/dev_{split_number}.statement.jsonl'
            args.inhouse_train_qids = f'{args.data_dir}/{args.dataset}/inhouse_split_qids_{split_number}.txt'
            args.train_adj = f'{args.data_dir}/{args.dataset}/graph/train_{split_number}.graph.adj.pk'
            args.dev_adj = f'{args.data_dir}/{args.dataset}/graph/dev_{split_number}.graph.adj.pk'
            args.test_adj = f'{args.data_dir}/{args.dataset}/graph/test_{split_number}.graph.adj.pk'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_statements')
    parser.add_argument('--dev_statements')
    parser.add_argument('--test_statements')
