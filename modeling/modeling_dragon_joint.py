...
class DRAGON(nn.Module):
    ...
    def forward(self, *inputs, cache_output=False, detail=False, t_type=0):
        """
        ...
        *lm_inputs, concept_ids, node_type_ids, node_scores, adj_lengths, special_nodes_mask, edge_index, edge_type, pos_triples, neg_nodes = _inputs
        ...
        logits, lm_loss, link_losses = self.lmgnn(lm_inputs, concept_ids,
                                    ...
                                    emb_data=None, cache_output=cache_output, t_type=t_type)
...
class LMGNN(PreTrainedModelClass):
    ...
    def forward(self, inputs, concept_ids, node_type_ids, node_scores, adj_lengths, special_nodes_mask, adj, lp_data, emb_data=None, cache_output=False, t_type=0):
        """
